<?php
$titleTag = "Elite Auto Motors | About Us";
require_once "../VisitorLayout/header.php";
?>

<div class="w-full h-75 md:h-160 bg-cover flex flex-col justify-center items-center text-white mb-20 md:mb-0"
    style="background-image:url('../Assets/about_banner.png')">
    <div class="md:w-4/5 mx-auto text-center">
        <h1 class="text-2xl md:text-6xl font-medium mb-2">Experience <span class="text-[#EDC549]">Dubai </span>in
            Unmatched <span class="text-[#EDC549]">Luxury</span>
        </h1>
    </div>
</div>

<div class="container-fluid text-center mt-20 mb-10">
    <h3 class="text-3xl md:text-5xl font-light">Who <span class="text-[#7B5D01] font-medium">We Are?</span></h3>
</div>
...
<div
    ...
    <div class="w-80 md:w-2/5">
        <p class="font-light text-justify text-base md:text-2xl">
            <span class="text-[#513E04] font-bold">Elite Auto Motors</span>
            is Dubai’s premier luxury car rental service, offering an elite fleet of exotic, sports,
            and executive vehicles for clients who value style, speed, and sophistication. We specialize in delivering
            world-class rental experiences tailored to tourists, business executives, and locals seeking a touch of
            prestige.
        </p>
        <p class="font-light text-justify text-base md:text-2xl">
            With a passion for high-performance machines and luxury service, we’ve built our brand around trust,
            flexibility, and 5-star client satisfaction.
...
<div class="container-fluid text-center mt-20 mb-10">
    <h3 class="text-3xl md:text-5xl font-light">Our <span class="text-[#7B5D01] font-medium">Mission</span></h3>
</div>
...
<div
    ...
    <div class="w-80 md:w-2/5">
        <p class="font-light text-justify text-base md:text-2xl">
            To redefine luxury transportation in the UAE by making world-renowned car brands accessible for
            unforgettable experiences — whether you're cruising through Dubai Marina, arriving at a business meeting, or
...
<div class="container-fluid text-center mt-20 mb-10">
    <h3 class="text-3xl md:text-5xl font-light">Who We <span class="text-[#7B5D01] font-medium">Serve?</span></h3>
</div>
...
<div class="container-fluid text-center mt-20 mb-10">
    <h3 class="text-3xl md:text-5xl font-light">Our <span class="text-[#7B5D01] font-medium">Promise</span></h3>
</div>

<div
    class="container-fluid w-full flex flex-col-reverse md:flex-row justify-center items-center md:space-x-20 space-y-5 md:space-y-0">
    <div class="w-80 md:w-2/5">
        <p class="font-light text-justify text-base md:text-2xl"> At <span class="text-[#513E04] font-bold">Elite Auto
                Motors, </span>we don’t
            just rent cars — we deliver experiences. Every key handed over is a promise of performance, luxury, and
            trust.
        </p>
    </div>

    <div class="w-80 md:w-2/5">
        <img src="../Assets/promise.png" alt="a person holding car key">
    </div>
</div>


<div class="mt-20 md:mt-50 w-full h-80 md:h-132 text-white flex flex-col justify-center text-start p-10 bg-cover"
