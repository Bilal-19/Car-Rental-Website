...
<div class="w-full h-80 md:h-180 bg-cover flex flex-col justify-center items-center text-white mb-20 md:mb-0"
    ...
    <div class="md:w-4/5 mx-auto text-center">
        <h1 class="text-3xl md:text-6xl font-medium mb-2">Let’s Get You on the <span class="text-[#EDC549]">Road</span> in <span
                class="text-[#EDC549]">Style</span></h1>
        <p class="md:w-4/6 mx-auto text-base md:text-2xl font-medium">
            Need help booking your dream car? Have a special request or corporate inquiry? We’re here 24/7 to assist you.
        </p>
    </div>
</div>
...
<div class="w-full md:h-fit bg-cover flex flex-col justify-center items-center text-white mt-30 py-10 bg-no-repeat bg-scroll"
    ...
    <div class="md:w-4/5 mx-auto text-center md:my-60">
        ...
        <form action="" class="space-y-5">
            <input type="text" class="bg-white text-black px-3 md:px-6 py-3 rounded-2xl w-80 md:w-3/5 focus:outline-none" name="full_name" placeholder="Full Name">

            <input type="email" class="bg-white text-black px-3 md:px-6 py-3 rounded-2xl w-80 md:w-3/5 focus:outline-none" name="email_address" placeholder="Email Address">

            <input type="number" class="bg-white text-black px-3 md:px-6 py-3 rounded-2xl w-80 md:w-3/5 focus:outline-none" name="phone" placeholder="Phone / Whatsapp">

            <input type="text" class="bg-white text-black px-3 md:px-6 py-3 rounded-2xl w-80 md:w-3/5 focus:outline-none" name="subject" placeholder="Subject">

            <textarea class="bg-white text-black px-3 md:px-6 py-3 rounded-2xl w-80 md:w-3/5 focus:outline-none" name="message" rows="5" placeholder="Message"></textarea>
