...
<div class="container-fluid text-center mt-20 mb-10">
    <h3 class="text-3xl md:text-5xl font-light">How it <span class="text-[#7B5D01] font-medium">Works?</span></h3>
</div>
...
<div class="container-fluid text-center mt-20 mb-10">
    <h3 class="text-3xl md:text-5xl font-light">Customer <span class="text-[#7B5D01] font-medium">Testimonials</span>
    </h3>
    <p class="text-md md:text-2xl font-light">What Our Clients Say</p>
</div>

<div class="w-full flex flex-col md:flex-row justify-around items-center space-y-15 md:space-y-0">
    <div class="w-80 md:w-2/5 bg-white rounded-3xl py-3 px-10 h-42 flex flex-col justify-center">
        <h4 class="font-medium text-2xl">Ahmed R, KSA</h4>
        <div>
        ...
        <p class="font-light text-xl">Rented a Lamborghini for my Dubai trip — flawless service!</p>
    </div>

    <div class="w-80 md:w-2/5 bg-white rounded-3xl py-3 px-10 h-42 flex flex-col justify-center">
        <h4 class="font-medium text-2xl">Jessica M., UK</h4>
        <div>
            <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
            <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
            <i class="fa-solid fa-star" style="color: #FFD43B;"></i>
        ...
        <p class="font-light text-xl">Delivered to my hotel within an hour. Highly recommend!</p>
    </div>
</div>

<div class="mt-30 w-full h-52 md:h-100 text-white flex flex-col justify-center text-start p-10" style="background-image:url('../Assets/footer_cta_banner.png')">
